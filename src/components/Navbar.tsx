...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-10 border-b border-[#f99e1a]/60 bg-[#f8fbff]/85 shadow-[0_8px_20px_rgba(34,58,97,0.16)] backdrop-blur">
      <nav
        className="mx-auto flex w-full max-w-7xl flex-wrap items-center gap-2 px-3 py-3 sm:gap-5 sm:px-6 lg:px-8"
      ...
      >
        {navItems.map((item) => (
          <NavLink
            ...
            className={({ isActive }) =>
              [
                "rounded-sm border px-3 py-2 text-xs font-semibold uppercase tracking-wide transition-colors duration-200 sm:text-sm",
                isActive
